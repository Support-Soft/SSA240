codeunit 71904 "SSAFTSAFT XML Helper"
{
    ...
    procedure WriteXmlDocToAuditLine(var SAFTExportLine: Record "SSAFTSAFT Export Line")
    var
    ...
    procedure WriteXmlDocToAuditHeader(var SAFTExportHeader: Record "SSAFTSAFT Export Header")
    var
        FileOutStream: OutStream;
    begin
