codeunit 71905 "SSAFT Export Mgt."
{
    // SSM2101 SSCAT 04.01.2023 SAF-T

    TableNo = "SSAFT Export Header";
    ...
    local procedure StartExport(var SAFTExportHeader: Record "SSAFT Export Header")
    var
    ...
    procedure DeleteExport(var SAFTExportHeader: Record "SSAFT Export Header")
    var
    ...
    procedure RestartTaskOnExportLine(var SAFTExportLine: Record "SSAFT Export Line")
    var
    ...
    procedure UpdateExportStatus(var SAFTExportHeader: Record "SSAFT Export Header")
    var
        SAFTExportLine: Record "SSAFT Export Line";
        TypeHelper: Codeunit "Type Helper";
        TotalCount: Integer;
    ...
    procedure StartExportLinesNotStartedYet(SAFTExportHeader: Record "SSAFT Export Header")
    var
        SAFTExportLine: Record "SSAFT Export Line";
        NoOfJobs: Integer;
        NotBefore: DateTime;
    ...
    procedure ShowActivityLog(SAFTExportLine: Record "SSAFT Export Line")
    var
    ...
    procedure ShowErrorOnExportLine(SAFTExportLine: Record "SSAFT Export Line")
    var
        ActivityLog: Record "Activity Log";
        Stream: InStream;
        ErrorMessage: Text;
    ...
    procedure LogSuccess(SAFTExportLine: Record "SSAFT Export Line")
    var
        ActivityLog: Record "Activity Log";
    begin
    ...
    procedure LogError(SAFTExportLine: Record "SSAFT Export Line")
    var
        ActivityLog: Record "Activity Log";
        ErrorMessage: Text;
    begin
    ...
    local procedure LogState(SAFTExportLine: Record "SSAFT Export Line"; Description: Text[250])
    var
        ActivityLog: Record "Activity Log";
    begin
    ...
    local procedure StartExportLines(SAFTExportHeader: Record "SSAFT Export Header")
    var
        SAFTExportLine: Record "SSAFT Export Line";
        NoOfJobs: Integer;
        NotBefore: DateTime;
    ...
    local procedure RunGenerateSAFTFileOnSingleLine(var SAFTExportLine: Record "SSAFT Export Line"; var NoOfJobs: Integer; var NotBefore: DateTime; SAFTExportHeader: Record "SSAFT Export Header")
    var
    ...
    begin
            ...
            if DoNotScheduleTask then
                ...
                SAFTExportLine."Task ID" :=
                  TASKSCHEDULER.CreateTask(
                    CODEUNIT::"SSAFT Generate File", CODEUNIT::"SSAFT Export Error Handler", true, CompanyName,
        ...
        ClearLastError;
        if not CODEUNIT.Run(CODEUNIT::"SSAFT Generate File", SAFTExportLine) then
            CODEUNIT.Run(CODEUNIT::"SSAFT Export Error Handler", SAFTExportLine);
        Commit;
    end;

    local procedure PrepareForExport(var SAFTExportHeader: Record "SSAFT Export Header"): Boolean
    var
        TempErrorMessage: Record "Error Message" temporary;
        SAFTExportCheck: Codeunit "SSAFT Export Check";
    begin
    ...
    local procedure CreateExportLines(SAFTExportHeader: Record "SSAFT Export Header")
    var
        SAFTExportLine: Record "SSAFT Export Line";
        LineNo: Integer;
        i: Integer;
    ...
    local procedure InsertSAFTExportLine(var SAFTExportLine: Record "SSAFT Export Line"; var LineNo: Integer; SAFTExportHeader: Record "SSAFT Export Header"; _TypeOfLine: Integer; Description: Text; var _SegmentIndex: Integer)
    begin
        SAFTExportLine.Init;
    ...
    local procedure RemoveExportLines(var SAFTExportHeader: Record "SSAFT Export Header")
    var
        SAFTExportLine: Record "SSAFT Export Line";
    begin
        SAFTExportLine.SetRange(ID, SAFTExportHeader.ID);
    ...
    local procedure RemoveExportLine(var SAFTExportLine: Record "SSAFT Export Line")
    begin
        CancelTask(SAFTExportLine);
        SAFTExportLine.Delete(true);
    end;

    local procedure CancelTask(SAFTExportLine: Record "SSAFT Export Line")
    var
    ...
    procedure BuildZipFilesWithAllRelatedXmlFiles(SAFTExportHeader: Record "SSAFT Export Header")
    var
    ...
    procedure DownloadZipFileFromExportHeader(SAFTExportHeader: Record "SSAFT Export Header")
    var
    ...
    begin
        ScheduledTask.SetRange("Run Codeunit", CODEUNIT::"SSAFT Generate File");
    ...
    local procedure CheckLineStatusForRestart(var SAFTExportLine: Record "SSAFT Export Line"): Boolean
    begin
    ...
    procedure IsValidLine(SAFTExportHeader: Record "SSAFT Export Header"; SAFTExportLine: Record "SSAFT Export Line"): Boolean
    begin
    ...
    procedure StartExportSingleFile(var SAFTExportHeader: Record "SSAFT Export Header")
    var
        TypeHelper: Codeunit "Type Helper";
    begin
        //SSM1724>>
    ...
    local procedure StartExportSingleLine(SAFTExportHeader: Record "SSAFT Export Header")
    var
        SSASAFTGenerateFile: Codeunit "SSAFT Generate File";
    begin
        //SSM1724>>
