report 70902 "SSA Sales - Credit Memo"
{
    RDLCLayout = './src/rdlc/SSA Sales - Credit Memo.rdlc';
    WordLayout = './src/rdlc/SSA Sales - Credit Memo.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            column(NrCrtLbl; NrCrtLbl)
            {
            }
            column(DateLbl; DateLbl)
            {
            }
            column(StornoInvoiceLbl; StornoInvoiceLbl)
            {
            }
            ...
            column(CompanyInfo_ShipToName; CompanyInfo."Ship-to Name")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_ShiptoAddress; CompanyInfo."Ship-to Address")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_ShiptoAddress2; CompanyInfo."Ship-to Address 2")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_ShiptoCity; CompanyInfo."Ship-to City")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_ShiptoPostCode; CompanyInfo."Ship-to Post Code")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_ShiptoCountry; CompanyInfo."Ship-to Country/Region Code")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_ShiptoContact; CompanyInfo."Ship-to Contact")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_CommTradeNo; CompanyInfo."SSA Commerce Trade No.")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_BankName1; CompanyInfo."SSA Bank Name 1")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_IBAN1; CompanyInfo."SSA IBAN 1")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_SWIFTCode1; CompanyInfo."SSA SWIFT Code 1")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_BankName2; CompanyInfo."SSA Bank Name 2")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_IBAN2; CompanyInfo."SSA IBAN 2")
            {
                IncludeCaption = true;
            }
            column(CompanyInfo_SWIFTCode2; CompanyInfo."SSA SWIFT Code 2")
            {
                IncludeCaption = true;
            }
            column(SSA_Commerce_Trade_No_; "SSA Commerce Trade No.")
            {
                IncludeCaption = true;
            }
            ...
            dataitem(Line; "Sales Cr.Memo Line")
            {
                ...
                column(Quantity_Line; format(-Quantity))
                {
                }
                ...
                dataitem(ShipmentLine; "Sales Shipment Buffer")
                {
                    ...
                    column(PostingDate_ShipmentLine; format("Posting Date", 0, '<Day,2>.<Month,2>.<Year4>'))
                    {
                    }
                ...
                begin
                    ...
                    FormattedLineAmount := format(-"Line Amount", 0, AutoFormatManagement.ResolveAutoFormat(1, Line.GetCurrencyCode()));
            ...
            begin
                ...
                if "Language Code" <> '' then
                    CurrReport.Language := LanguageCodeunit.GetLanguageID("Language Code");
    ...
    var
        ...
        SalesCreditMemoLbl: Label 'Storno Fiscal Invoice';
        ...
        NrCrtLbl: Label 'Nr. Crt.';
        NrCrt: Integer;
        DateLbl: Label 'Date (dd.mm.yyyy)';
        StornoInvoiceLbl: Label 'Storno Invoice';
