page 70022 "SSA Pretty Cash Journal"
{
            ...
            group(Control30)
            {
                ...
                group("Balance Account Amount")
                {
                    ...
                    field(DateOfBalance; DateOfBalance)
                    {
                        ...
                        begin
                            //SSA1199>>
                            SetRange("SSA Date Filter", 0D, DateOfBalance);
                            SetRange("SSA Date Filter -1D", 0D, CalcDate('<-1D>', DateOfBalance));

                            CalcFields("SSA Total Amount (LCY)",
                            ...
                            //SSA1199<<
                            CalcFields("SSA Debit Amount -1D",
                    ...
                    field("Bal Acc Balance -1D (LCY)"; "SSA Debit Amount -1D (LCY)" - "SSA Credit Amount -1D (LCY)")
                    {
                        Caption = 'Bal Acc Balance -1D (LCY)';
                        ApplicationArea = All;
                    }
                    field("Bal Acc Balance (LCY)"; "SSA Debit Amount (LCY)" - "SSA Credit Amount (LCY)" - "SSA Total Amount (LCY)")
                    {
                        Caption = 'Bal Acc Balance (LCY)';
                        ApplicationArea = All;
                    }
                    field(BalAccBalance1D; "SSA Debit Amount -1D" - "SSA Credit Amount -1D")
                    {
                        Caption = 'Bal Acc Balance -1D';
                        ApplicationArea = All;
                    }
                    field(BalAccBalance; "SSA Debit Amount" - "SSA Credit Amount" - "SSA Total Amount")
                    {
            ...
            group("Page")
            {
                ...
                action(ClassicView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close;
                        GenJnlManagement.SetJournalSimplePageModePreference(false, PAGE::"SSA Pretty Cash Journal");
                        GenJnlManagement.SetLastViewedJournalBatchName(PAGE::"SSA Pretty Cash Journal", CurrentJnlBatchName);
                        PAGE.Run(PAGE::"SSA Pretty Cash Journal");
                    end;
                }
                action(SimpleView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close;
                        GenJnlManagement.SetJournalSimplePageModePreference(true, PAGE::"SSA Pretty Cash Journal");
                        GenJnlManagement.SetLastViewedJournalBatchName(PAGE::"SSA Pretty Cash Journal", CurrentJnlBatchName);
                        PAGE.Run(PAGE::"SSA Pretty Cash Journal");
                    end;
                }
    ...
    begin
        CalcFields("SSA Bal Acc Balance -1D (LCY)",
            "SSA Debit Amount -1D (LCY)",
            "SSA Credit Amount -1D (LCY)",
            "SSA Bal Acc Balance (LCY)",
            "SSA Debit Amount (LCY)",
    ...
    begin
        ...
        then
            ...
            IsSimplePage := GenJnlManagement.GetJournalSimplePageModePreference(PAGE::"SSA Pretty Cash Journal");
    end;
    ...
    begin
        ...
        GenJnlManagement.TemplateSelection(PAGE::"SSA Pretty Cash Journal", 0, false, Rec, JnlSelected);
        if not JnlSelected then
            Error('');

        LastGenJnlBatch := GenJnlManagement.GetLastViewedJournalBatchName(PAGE::"SSA Pretty Cash Journal");
