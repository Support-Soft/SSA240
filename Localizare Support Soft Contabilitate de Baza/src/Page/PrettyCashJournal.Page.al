        ...
        area(Content)
        {
            ...
            group(Control30)
            {
                ...
                group("Balance Account Amount")
                {
                    ...
                    field("Bal Acc Balance -1D (LCY)"; Rec."SSA Debit Amount -1D (LCY)" - Rec."SSA Credit Amount -1D (LCY)")
                    {
                        Caption = 'Bal Acc Balance -1D (LCY)';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the Bal Acc Balance -1D (LCY) field.';
                    }
                    field("Bal Acc Balance (LCY)"; Rec."SSA Debit Amount (LCY)" - Rec."SSA Credit Amount (LCY)" - Rec."SSA Total Amount (LCY)")
                    {
