                ...
                group("Balance Account Amount")
                {
                    ...
                    field(DateOfBalance; DateOfBalance)
                    {
                        ...
                        begin
                            ...
                            CalcFields("SSA Total Amount (LCY)", "SSA Bal Acc Balance (LCY)",
                    ...
                    field(BalAccBalance1DLCY; "SSA Debit Amount -1D (LCY)" - "SSA Credit Amount -1D (LCY)")
                    {
                        Caption = 'Bal Acc Balance -1D (LCY)';
                        ApplicationArea = All;
                    }
                    field(BalAccBalanceLCY; "SSA Debit Amount (LCY)" - "SSA Credit Amount (LCY)" - "SSA Total Amount (LCY)")
                    {
