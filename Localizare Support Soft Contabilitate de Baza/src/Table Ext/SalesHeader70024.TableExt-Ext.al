tableextension 70024 "SSA Sales Header70024" extends "Sales Header"
{
    ...
    fields
    {
        ...
        field(70001; "SSA Stare Factura"; Option)
        {
            ...
            begin
                //SSA973>>
                if "SSA Stare Factura" in ["SSA Stare Factura"::"3-Autofactura", "SSA Stare Factura"::"4-In calidate de beneficiar in numele furnizorului"] then
