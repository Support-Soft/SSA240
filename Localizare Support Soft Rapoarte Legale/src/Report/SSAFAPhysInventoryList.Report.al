            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(PrintFAValues; PrintFAValues)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the Print FA Values field.';
                    }
                    field(PrintZeroBookValue; PrintZeroBookValue)
                    {
                        Caption = 'Print FA with Zero Book Value';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the Print FA with Zero Book Value field.';
                    }
                    ...
                    field("Member[1]"; Member[1])
                    {
                        Caption = '1. Persona';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the 1. Persona field.';
                    }
                    field("Member[2]"; Member[2])
                    {
                        Caption = '2. Persona';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the 2. Persona field.';
                    }
                    field("Member[3]"; Member[3])
                    {
                        Caption = '3. Persona';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the 3. Persona field.';
                    }
                }
            }
        }
