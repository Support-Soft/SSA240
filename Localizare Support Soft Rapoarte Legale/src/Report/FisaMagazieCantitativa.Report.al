report 71307 "SSA Fisa Magazie Cantitativa"
{
    ...
    var
        ...
        HasMovement: Boolean;
        ShowACY: Boolean;
        PurchUnitYes: Boolean;
        ItemFooter: Boolean;
        DateMin: Date;
        DateMax: Date;
        ItemLedgerEntryf: Text[1024];
        test: Text[50];
        Text000: Label 'Input Amt. (ACY)';
        Text001: Label 'Output Amt. (ACY)';
        Text002: Label 'Inventory Amt. (ACY)';
        Text003: Label 'Unit Cost Calc. (ACY)';
        Text004: Label 'Input Amt.';
        Text005: Label 'Output Amt.';
        Text006: Label 'Inventory Amt.';
        Text007: Label 'Unit Cost Calc.';
        Text008: Label 'Location Code: ';
        Text009: Label 'Location Name: ';
        Text010: Label 'Location Address: ';
        Text011: Label 'Inventory Posting Group ';
        Text012: Label 'Item No. ';
        Text013: Label 'Description: ';
        Text014: Label 'Total Inventory Posting Group ';
        index1: Integer;
