report 71318 "SSA Vendor - Detail Trial Bal"
{
    // SSA967 SSCAT 07.10.2019 33.Funct. Filtrare pe posting group
    DefaultLayout = RDLC;
    RDLCLayout = './src/rdlc/SSA Vendor - Detail Trial Bal.rdlc';
            ...
            dataitem(Vendor; Vendor)
            {
                ...
                dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
                {
                    ...
                    begin
                        ...
                        //SSA967>>
                        if VPG.Code <> '' then
                            SetFilter("Vendor Posting Group", VPG.Code);
                        //SSA967<<
                    end;
                }
                ...
                begin
                    ...
                    StartBalanceLCY := 0;
                    StartBalAdjLCY := 0;
                    if VendDateFilter <> '%1|%2' then begin
                        if GetRangeMin("Date Filter") <> 0D then begin
                            ...
                            */
                            VLE.SetFilter("Date Filter", GetFilter("Date Filter"));
                            if VLE.FindSet then
                                repeat
                                    VLE.CalcFields("Remaining Amt. (LCY)");
                                    StartBalanceLCY += -VLE."Remaining Amt. (LCY)";
                                until VLE.Next = 0;
                            //SSA967<<
                        end;
                        ...
                        VendorLedgerEntry.SetRange("Vendor Posting Group", VPG.Code); //SSA967
