report 71302 "SSABal. verif. sold prec(4 eg)"
{
    // SSA978 SSCAT 08.10.2019 45.Rapoarte legale-Balanta de verificare solduri precedente
    DefaultLayout = RDLC;
    RDLCLayout = './src/rdlc/SSABalverifsoldprec4eg.rdlc';
    Caption = 'Balanta verif. sold prec(4 eg)';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(InitialDebitBalance; InitialDebitBalance + DebitMovements)
                {
                }
                column(InitialCreditBalance; InitialCreditBalance + CreditMovements)
                {
                }
                ...
                column(TotalAmounts_Debit; InitialDebitBalance + DebitAmount + DebitMovements)
                {
                }
                column(TotalAmounts_Credit; InitialCreditBalance + CreditAmount + CreditMovements)
                {
                }
                ...
                column(TotalInitDebitBalance; TotalInitDebitBalance + TotalDebitMovements)
                {
                }
                column(TotalInitCreditBalance; TotalInitCreditBalance + TotalCreditMovements)
                {
                }
                ...
                column(TotalAmounts_TotalDebit; TotalInitDebitBalance + TotalDebit + TotalDebitMovements)
                {
                }
                column(TotalAmounts_TotalCredit; TotalInitCreditBalance + TotalCredit + TotalCreditMovements)
                {
                }
            ...
            begin
                ...
                if Fdperiod = Firstdayyear then
                    Col_Init := Col_InitialBalance
                else
                    Col_Init := Col_InitialBal;
        ...
        layout
        {
            area(content)
            {
                field(PrintChartAcc; all)
                {
                    ...
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Print Chart of Accounts field.';
                }
                ...
                field(ShowACY; ShowACY)
                {
                    ...
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Print Amounts In Add. Currency field.';
                }
    ...
    var
        ...
        GlobalDim2: Text[20];
        Col_Init: Text[30];
        Col_InitialBal: Label 'Previous Amounts';
}
